...
import org.firstinspires.ftc.teamcode.Decode.holonomicConstants;

import java.util.function.Supplier;

@Configurable
@TeleOp
public class holonomicManual extends OpMode {
    ...
    public void init() {
        ...
        follower = holonomicConstants.createFollower(hardwareMap);
